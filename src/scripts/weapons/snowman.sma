...
public plugin_precache() {
  ...
  CW_RegisterClass(SW_Weapon_Snowman, SW_Weapon_BaseBlueprint);

  CW_ImplementClassMethod(SW_Weapon_Snowman, CW_Method_Create, "@Weapon_Create");
  ...
  CW_RegisterClassMethod(SW_Weapon_Snowman, SW_Weapon_BaseBlueprint_Method_CreateInstallation, "@Weapon_CreateInstallation");
}

public plugin_init() {
  register_plugin("[Entity] (Snow Wars) Snowman", SW_VERSION, "Hedgehog Fog");
}
...
@Weapon_CreateInstallation(const this) {
  return CE_Create(SW_Entity_Snowman);
}
