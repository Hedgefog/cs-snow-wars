...
public plugin_precache() {
  Asset_Precache(ASSET_LIBRARY, ASSET(Weapon_Fireworksbox_Model_View), g_szVModel, charsmax(g_szVModel));
  Asset_Precache(ASSET_LIBRARY, ASSET(Weapon_Fireworksbox_Model_Player), g_szPModel, charsmax(g_szPModel));
  Asset_Precache(ASSET_LIBRARY, ASSET(Weapon_Fireworksbox_Model_World), g_szWModel, charsmax(g_szWModel));
